...
export class SeedService {
  ...
  async seedMenus(): Promise<void> {
    ...
    const curated: Array<{
      ...
      { title: 'Bun Cha Hanoi Style', cuisine: 'Vietnamese', mealType: 'lunch', imageUrl: 'https://images.unsplash.com/photo-1512054507848-54b8c4a4364b?auto=format&fit=crop&w=800&h=600&q=85', budgetMin: 125, budgetMax: 210, allergens: [] },
      ...
      { title: 'Kung Pao Chicken Deluxe', cuisine: 'Chinese', mealType: 'dinner', imageUrl: 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?auto=format&fit=crop&w=800&h=600&q=85', budgetMin: 135, budgetMax: 215, allergens: ['peanut','soy'] },
